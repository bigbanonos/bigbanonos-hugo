...
<!-- Title of the Post -->
<h1>BigBanonos' Favorite Songs by Jax Jones</h1> <!-- Introductory Text -->
...
<div> {{< img-lite src="https://backstage.officialcharts.com/sites/default/files/legacy_images/media/655225/jax-jones-1100.jpg" alt="Jax Jones" >}}
</div> <!-- Spotify Embed -->
<div> {{< youtube "embed" >}}
