...
<p><strong>"Test Pattern"</strong> â€“ <em>The Body, The Blood, The Machine</em> (Sub Pop Records, 2006)</p> {{< youtube "embed" >}} <p>#NotOnSpotify #Live</p> {{< youtube "s_wCdEz1MS8" >}} <p><strong>Everything Thermals (Session Recording) 2008</strong></p> {{< youtube "hPsdjlPVaJU" >}} <p>@thethermals</p> <hr />
<!-- Footer -->
