...
</div> <p>This collection from <em>BigBanonos</em> features A Grave With No Name, a blend of folk and popgaze with beautifully ambient tracks from albums released over the past decade.</p> <ol> <li><strong>By The Water's Edge</strong> " <em>October 10, 2011</em> " Album: Lower | Label: Boiled Egg | Genres: Folk/Acoustic, popgaze</li> <li><strong>Zachary</strong> " <em>November 17, 2009</em> " Album: Mountain Debris | Label: Lefse Records | Genres: Folk/Acoustic, popgaze</li> <li><strong>Sofia</strong> " <em>November 17, 2009</em> " Album: Mountain Debris | Label: Lefse Records | Genres: Folk/Acoustic, popgaze</li>
</ol> <p>Listen to the playlist on Spotify:</p>
{{< youtube "embed" >}}
{{< youtube "HSMzYcjwmaE" >}}<br />
<hr />
